...
export function getAdminMassTestFormats(formatRows = []) {
  ...
  return DEFAULT_CONTENT_FORMAT_LIBRARY.map((item) => {
    ...
    return {
      ...
      labelKey: item.content_type_id === "carousel_website_item"
        ? "automation.contentType.carousel_website_item.shortLabel"
        : null,
      descriptionKey: item.content_type_id === "carousel_website_item"
        ? "automation.contentType.carousel_website_item.description"
        : null,
...
export function mapCampaignPostContentType(post, brand) {
  ...
  const mapping = {
    ...
    problem_solution:"problem_solution", tips:"tips", mistakes:"tips", faq:"faq", checklist:"guide_choice",
    guide_choice:"guide_choice", engagement_humor:"engagement_humor",
    service_focus:"service_focus", website_service:"service_focus", myth_fact:"tips", seasonal:"tips", mini_guide:"guide_choice",
  };
