...
const checks = [
  ...
  ['Shopify locale is placed on onboarding URL before first render', /onboardingUrl\(origin, \{ lang: onboardingSession\.installer_locale/.test(callback)],
  ['Client applies Shopify locale to Spreelo language state', /setLocale\(bootstrap\.locale, "shopify"\)/.test(page)],
