...
- Market and language detection rules:
  ...
  - If Preferred content language is not provided, detect the main customer-facing language from the visible website text and write all user-facing fields in that language.
  ...
  - If the website is mainly written in a local language, use that local language even if the app dropdown does not contain that market or language.
  ...
  - For example, if the website is written in Uzbek, use Uzbek for content_language and write profile/campaign fields in Uzbek.
  - For example, if the website is written in Lao, use Lao for content_language and write profile/campaign fields in Lao.
  - For example, if the website is written in Thai, use Thai for content_language and write profile/campaign fields in Thai.
  - For example, if the website is written in Romanian, use Romanian for content_language and write profile/campaign fields in Romanian.
