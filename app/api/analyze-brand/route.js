...
function inferMarketSetup({
  ...
  const marketRules = [
    {
      match: [".se", "/se/", "sweden", "sverige", "swedish", "svenska", "sek"],
      contentMarket: "Sweden",
      countryCode: "SE",
      contentLanguage: "Swedish",
    },
    {
      match: [".dk", "/dk/", "denmark", "danmark", "danish", "dansk", "dkk"],
      contentMarket: "Denmark",
      countryCode: "DK",
      contentLanguage: "Danish",
    },
    {
      match: [".no", "/no/", "norway", "norge", "norwegian", "norsk", "nok"],
      contentMarket: "Norway",
      countryCode: "NO",
      contentLanguage: "Norwegian",
    },
    {
      match: [".fi", "/fi/", "finland", "finnish", "suomi"],
      contentMarket: "Finland",
      countryCode: "FI",
      contentLanguage: "Finnish",
    },
    {
      match: [".de", "/de/", "germany", "deutschland", "german", "deutsch"],
      contentMarket: "Germany",
      countryCode: "DE",
      contentLanguage: "German",
    },
    {
      match: [".nl", "/nl/", "netherlands", "nederland", "dutch"],
      contentMarket: "Netherlands",
      countryCode: "NL",
      contentLanguage: "Dutch",
    },
    {
      match: [".fr", "/fr/", "france", "french", "français"],
      contentMarket: "France",
      countryCode: "FR",
      contentLanguage: "French",
    },
    {
      match: [".es", "/es/", "spain", "españa", "spanish"],
      contentMarket: "Spain",
      countryCode: "ES",
      contentLanguage: "Spanish",
    },
    {
      match: [".it", "/it/", "italy", "italia", "italian"],
      contentMarket: "Italy",
      countryCode: "IT",
      contentLanguage: "Italian",
    },
    {
      match: [".co.uk", ".uk", "/uk/", "united kingdom", "great britain", "britain", "gbp", "£"],
      contentMarket: "United Kingdom",
      countryCode: "GB",
      contentLanguage: "English",
    },
    {
      match: [".com.au", "/au/", "australia", "aud"],
      contentMarket: "Australia",
      countryCode: "AU",
      contentLanguage: "English",
    },
    {
      match: [".ca", "/ca/", "canada", "cad"],
      contentMarket: "Canada",
      countryCode: "CA",
      contentLanguage: "English",
    },
    {
      match: [".ae", "/ae/", "uae", "united arab emirates", "aed"],
      contentMarket: "United Arab Emirates",
      countryCode: "AE",
      contentLanguage: "English",
    },
    {
      match: [".in", "/in/", "india", "hindi", "inr"],
      contentMarket: "India",
      countryCode: "IN",
      contentLanguage: "English",
    },
