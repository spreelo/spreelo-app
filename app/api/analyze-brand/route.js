...
function inferMarketSetup({
  ...
  const marketRules = [
    ...
    {
      match: [".ca", "/ca/", "://ca.", "canada", "cad"],
      contentMarket: "Canada",
      countryCode: "CA",
      contentLanguage: "English",
    },
    {
      match: [".com.au", "/au/", "://au.", "australia", "aud"],
      contentMarket: "Australia",
      countryCode: "AU",
      contentLanguage: "English",
    },
    {
      match: [".co.nz", ".nz", "/nz/", "://nz.", "new zealand", "nzd"],
      contentMarket: "New Zealand",
      countryCode: "NZ",
      contentLanguage: "English",
    },
    {
  ...
  contentLanguage: "English",
    ...
    {
      match: [".fi", "/fi/", "://fi.", "finland", "finnish", "suomi"],
    ...
    {
      match: [".be", "/be/", "://be.", "belgium", "belgië", "belgique"],
      contentMarket: "Belgium",
      countryCode: "BE",
      contentLanguage: "Dutch",
    },
    {
      match: [".fr", "/fr/", "://fr.", "france", "french", "français"],
      contentMarket: "France",
      countryCode: "FR",
      contentLanguage: "French",
    },
    {
      match: [".es", "/es/", "://es.", "spain", "españa", "spanish"],
      contentMarket: "Spain",
      countryCode: "ES",
      contentLanguage: "Spanish",
    },
    {
      match: [".it", "/it/", "://it.", "italy", "italia", "italian"],
      contentMarket: "Italy",
      countryCode: "IT",
      contentLanguage: "Italian",
    },
    {
      match: [".pt", "/pt/", "://pt.", "portugal", "portuguese", "português"],
      contentMarket: "Portugal",
      countryCode: "PT",
      contentLanguage: "Portuguese",
    },
    {
      match: [".at", "/at/", "://at.", "austria"],
      contentMarket: "Austria",
      countryCode: "AT",
      contentLanguage: "German",
    },
    {
      match: [".ch", "/ch/", "://ch.", "switzerland", "schweiz", "suisse", "chf"],
      contentMarket: "Switzerland",
      countryCode: "CH",
      contentLanguage: "German",
    },
    {
      match: [".pl", "/pl/", "://pl.", "poland", "polska", "polish", "pln"],
      contentMarket: "Poland",
      countryCode: "PL",
      contentLanguage: "Polish",
    },

    {
      match: [".ae", "/ae/", "://ae.", "uae", "united arab emirates", "aed"],
      contentMarket: "United Arab Emirates",
      countryCode: "AE",
      contentLanguage: "English",
    },
    {
      match: [".sg", "/sg/", "://sg.", "singapore", "sgd"],
      contentMarket: "Singapore",
      countryCode: "SG",
      contentLanguage: "English",
    },
    {
      match: [".in", "/in/", "://in.", "india", "hindi", "inr"],
      contentMarket: "India",
      countryCode: "IN",
      contentLanguage: "English",
    },
    {
      match: [".co.za", ".za", "/za/", "://za.", "south africa", "zar"],
      contentMarket: "South Africa",
      countryCode: "ZA",
      contentLanguage: "English",
    },
    {
      match: [".br", "/br/", "://br.", "brazil", "brasil", "portuguese", "brl"],
      contentMarket: "Brazil",
      countryCode: "BR",
      contentLanguage: "Portuguese",
    },
    {
      match: [".mx", "/mx/", "://mx.", "mexico", "méxico", "spanish", "mxn"],
      contentMarket: "Mexico",
      countryCode: "MX",
      contentLanguage: "Spanish",
    },

    {
      match: ["global", "international", "worldwide", "shipping worldwide"],
